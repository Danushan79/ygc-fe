...
export function DoctorRecommendationCard({ consultTriage }: DoctorRecommendationCardProps) {
  ...
  if (!consultTriage || !consultTriage.consult_needed) {
    return (
      <div className="flex-shrink-0 rounded-xl border border-slate-200/80 bg-white shadow-sm ring-1 ring-slate-900/[0.02]">
        <div className="flex items-center gap-1.5 rounded-t-xl border-b border-slate-200 bg-gradient-to-r from-slate-50 to-white px-3 py-2">
  ...
  return (
    <div className="flex-shrink-0 rounded-xl border border-slate-200/80 bg-white shadow-sm ring-1 ring-slate-900/[0.02]">
      <div className="flex items-center justify-between rounded-t-xl border-b border-slate-200 bg-gradient-to-r from-blue-50 to-indigo-50/40 px-3 py-2">
      ...
      <div className="space-y-3 p-3">
        <div className="flex flex-wrap items-center justify-between gap-2 rounded-lg border border-slate-200 bg-slate-50 p-2.5">
          ...
          <button
            ...
            className="flex items-center gap-1.5 rounded-lg bg-gradient-to-b from-blue-700 to-blue-800 px-3 py-1.5 text-xs font-semibold text-white shadow-sm transition-all hover:brightness-105 active:brightness-95"
          >
