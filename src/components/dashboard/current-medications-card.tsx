...
const MEDICATIONS: Medication[] = [
  { name: "Metformin", dose: "500mg", instructions: "1 tab twice daily" },
  { name: "Lisinopril", dose: "10mg", instructions: "1 tab daily" },
];
  ...
  return (
    <div className="flex-shrink-0 rounded-lg border border-slate-200 bg-white shadow-sm">
      ...
      <div className="divide-y divide-slate-100">
        {MEDICATIONS.map((med) => (
          <div key={med.name} className="flex items-start gap-2 p-2">
